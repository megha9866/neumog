...
// Generate multiple sizes directly
...
export default function Icon({ id }: { id: string }) {
    // Use id to distinguish if we want different logic, or just let Next.js handle resizing?
    // Actually ImageResponse takes explicit dimensions.
    // We should match the generated metadata dimensions.

    const width = id === "medium" ? 192 : id === "large" ? 512 : 32;
    const height = width;
