        ...
        >
            <defs>
                <linearGradient id="logo-gradient" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stopColor="#7c3aed" /> {/* Violet-600: Represents Core/Structure */}
                    <stop offset="100%" stopColor="#ea580c" /> {/* Orange-600: Represents Speed/Network */}
                </linearGradient>
            </defs>

            {/* 
        This geometric 'N' represents the Neumog intent:
        The solid, architectural form symbolizes managed delivery and structure (The Core).
        The diagonal connection represents the bridge between internal teams and the expert network.
      */}
            <path
